...
<head>
    <meta charset="utf-8">
    <title>Mes recettes - Les recettes malines</title>
	...
	<section>
		<div id="searchbar">
			...
			<form id="searchrecette" method="post" action="traitement_form/traitementsearchrecettes.php">
                <input class="text" type="text" name="searchrecette" placeholder="Rechercher dans mes recettes"/>
                <i class="down"></i>
                <input class="button" type="submit" value="GO !"/>
            </form>
            <a href="ajoutrecette.php"><strong>+ Ajoutez une recette !</strong></a>
        </div>		
		<article id="article1">
